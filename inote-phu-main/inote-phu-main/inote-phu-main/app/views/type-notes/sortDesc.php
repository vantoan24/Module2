                ...
                <div>
                    <nav aria-label="Page navigation example">
                        <ul class="pagination d-flex justify-content-end">
                            <li class="page-item"><a class="page-link" href="index.php?controller=type_note&action=sort_desc&column=<?= $param['column'] ?>&page=<?= $param['pre'] ?>">Previous</a></li>
                            <?php for ($i = 1; $i <= $param['total_page']; $i++) : ?>
                                <li class="page-item"><a class="page-link" href="index.php?controller=type_note&action=sort_desc&column=<?= $param['column'] ?>&page=<?= $i ?>"><?= $i ?></a></li>
                            <?php endfor; ?>
                            <li class="page-item"><a class="page-link" href="index.php?controller=type_note&action=sort_desc&column=<?= $param['column'] ?>&page=<?= $param['next'] ?>">Next</a></li>
                        </ul>
                    </nav>
                </div>
            </div>
