            ...
            <div class="row mt-5">
                <div class="col-md-12">
                    <table class="table table-striped text-center table-bordered">
                        <tr>
                            <th>STT
                                <a href="index.php?controller=note&action=sort_desc&column=id">
                                    <i class="fa fa-fw fa-sort-down text-secondary"></i>
                                </a>
                            </th>
                            <th>Tiêu đề
                                <a href="index.php?controller=note&action=sort_desc&column=title">
                                    <i class="fa fa-fw fa-sort-down text-secondary"> </i>
                                </a>
                            </th>
                            <th>Phân loại
                                <a href="index.php?controller=note&action=sort_desc&column=name">
                                    <i class="fa fa-fw fa-sort-down text-secondary"> </i>
                                </a>
                            </th>
                            <th>Tác vụ</th>
                ...
                <div>
                    <nav aria-label="Page navigation example ">
                        <ul class="pagination d-flex justify-content-end">
                            <li class="page-item"><a class="page-link" href="index.php?controller=note&action=sort_asc&column=<?= $param['column'] ?>&page=<?= $param['pre'] ?>">Previous</a></li>
                            <?php for ($i = 1; $i <= $param['total_page']; $i++) : ?>
                                <li class="page-item"><a class="page-link" href="index.php?controller=note&action=sort_asc&column=<?= $param['column'] ?>&page=<?= $i ?>"><?= $i ?></a></li>
                            <?php endfor; ?>
                            <li class="page-item"><a class="page-link" href="index.php?controller=note&action=sort_asc&column=<?= $param['column'] ?>&page=<?= $param['next'] ?>">Next</a></li>
                        </ul>
                    </nav>
                </div>
            </div>
