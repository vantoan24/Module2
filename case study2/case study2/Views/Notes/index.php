        ...
        <tbody>
            <?php foreach ($notes as $key =>  $note) : ?>
                <tr>
                    ...
                    <!-- <td> <a href="index.php?controller=Note&action=delete&id=<?= $note->id ?>" onclick="return confirm ('Bạn có chắc muốn xóa tiêu dề không?')" class="btn btn"> <i class="fas fa-trash-alt fa-lg text-danger"></i></a></td> -->
                    <td>
                    <span data-toggle="modal" data-target="#delete<?= $note->id ?>"><i class='fas fa-archive fa-lg text-danger'></i></span>
                                    <!-- The Modal -->
